...
public class VanillaEnchantmentWrappers implements EnchantmentWrapperProvider {
    public static final VanillaEnchantmentWrappers instance = new VanillaEnchantmentWrappers();
    ...
    private VanillaEnchantmentWrappers() {}

    private static List<VanillaEnchantmentWrapper> vanilla() {
        return List.of(
    ...
    public List<VanillaEnchantmentWrapper> list() {
        ArrayList<VanillaEnchantmentWrapper> list = new ArrayList<>(vanilla());

        list.sort(Comparator.comparingInt(VanillaEnchantmentWrapper::getOrder));
