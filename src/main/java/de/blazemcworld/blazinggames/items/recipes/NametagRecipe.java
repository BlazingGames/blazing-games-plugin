...
public class NametagRecipe implements RecipeProvider {
    @Override
    public Map<NamespacedKey, Recipe> getRecipes() {
        NamespacedKey key = BlazingGames.get().key("nametag");

        ShapedRecipe nametagRecipe = new ShapedRecipe(key, new ItemStack(Material.NAME_TAG));
        nametagRecipe.shape(
                "  S",
                " P ",
                "P  "
