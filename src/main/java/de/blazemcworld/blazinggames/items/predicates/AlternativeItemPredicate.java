...
public class AlternativeItemPredicate implements ItemPredicate {
    List<ItemPredicate> predicates = new ArrayList<>();
    String description;

    public AlternativeItemPredicate add(ItemPredicate... predicate) {
        predicates.addAll(List.of(predicate));
        return this;
    }

    public AlternativeItemPredicate(String description, ItemPredicate... predicate) {
