...
public class ItemUtils {
    ...
    public static Material getUncoloredType(Material mat) {
        return switch(mat) {
            ...
            case OAK_LEAVES, SPRUCE_LEAVES, BIRCH_LEAVES, JUNGLE_LEAVES, ACACIA_LEAVES, DARK_OAK_LEAVES, MANGROVE_LEAVES, CHERRY_LEAVES,
                 WARPED_WART_BLOCK, NETHER_WART_BLOCK, PALE_OAK_LEAVES
                    -> Material.OAK_LEAVES;
            case OAK_PLANKS, SPRUCE_PLANKS, BIRCH_PLANKS, JUNGLE_PLANKS, ACACIA_PLANKS, DARK_OAK_PLANKS, MANGROVE_PLANKS, CHERRY_PLANKS,
                 WARPED_PLANKS, CRIMSON_PLANKS, BAMBOO_PLANKS, BAMBOO_MOSAIC, PALE_OAK_PLANKS
                    -> Material.OAK_PLANKS;
            case WOODEN_PICKAXE, STONE_PICKAXE, IRON_PICKAXE, GOLDEN_PICKAXE, DIAMOND_PICKAXE, NETHERITE_PICKAXE -> Material.WOODEN_PICKAXE;
            default -> mat;
        };
    }
