...
import de.blazemcworld.blazinggames.enchantments.eventhandlers.CapturingHandler;
...
public class EntityDeathEventListener extends BlazingEventListener<EntityDeathEvent> {
    public EntityDeathEventListener() {
        this.handlers.addAll(List.of(
                new CustomSlabShulkerDeathHandler(),
