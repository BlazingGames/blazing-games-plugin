...
public class BlazingBlockDisappearEventListener extends BlazingEventListener<BlazingBlockDisappearEvent> {
    ...
    @EventHandler
    public void event(BlazingBlockDisappearEvent event) {
        executeEvent(event);
    }
}
